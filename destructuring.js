// Opdracht 1[x]: Destructure price en refreshRate uit onderstaand object, en log ze daarna in de terminal
...
// Opdracht 2[x]: Destructure type en brand uit onderstaand object, en log ze daarna in de terminal
...
// Opdracht 3[x]: destructure wifi en bluetooth uit onderstaand object, en log ze daarna in de terminal
const tvOptions = {
  options: {
    colors: [
      'black',
...
const [thisName, thisAge] = getDetails("Ireen ", 40)
